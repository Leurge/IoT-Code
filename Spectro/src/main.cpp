...
void loop() {
	...
	//float data = sensor.getCalibratedR();
	Serial.println(sensor.getCalibratedR());
	// Serial.println(sensor.getCalibratedS());
	// Serial.println(sensor.getCalibratedT());
	// Serial.println(sensor.getCalibratedU());
	// Serial.println(sensor.getCalibratedV());
